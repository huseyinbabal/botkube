...
![Version: v0.40.0-rc.1](https://img.shields.io/badge/Version-v0.40.0--rc.1-informational?style=flat-square) ![AppVersion: v0.40.0-rc.1](https://img.shields.io/badge/AppVersion-v0.40.0--rc.1-informational?style=flat-square)
...
| [image.tag](./values.yaml#L20) | string | `"v0.40.0-rc.1"` | BotKube container image tag. Default tag is `appVersion` from Chart.yaml. |
