...
![Version: 1.34.0-rc.1](https://img.shields.io/badge/Version-1.34.0--rc.1-informational?style=flat-square) ![AppVersion: 1.34.0-rc.1](https://img.shields.io/badge/AppVersion-1.34.0--rc.1-informational?style=flat-square)
...
| [e2eTest.image.tag](./values.yaml#L634) | string | `"v9.99.9-dev"` | Test runner image tag. Default tag is `appVersion` from Chart.yaml. |
