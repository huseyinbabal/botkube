...
![Version: v0.44.1-rc.1](https://img.shields.io/badge/Version-v0.44.1--rc.1-informational?style=flat-square) ![AppVersion: v0.44.1-rc.1](https://img.shields.io/badge/AppVersion-v0.44.1--rc.1-informational?style=flat-square)
...
| [image.tag](./values.yaml#L20) | string | `"v0.44.1-rc.1"` | BotKube container image tag. Default tag is `appVersion` from Chart.yaml. |
...
| [e2eTest.image.tag](./values.yaml#L703) | string | `"v0.44.1-rc.1"` | Test runner image tag. Default tag is `appVersion` from Chart.yaml. |
